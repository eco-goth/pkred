...
; Route 3
	...
	db "BIGGY@",MOVES
		...
		db 15,BUTTERFREE,CONFUSION,TACKLE,POISON_POWDER,NO_MOVE
	db -1
; Mt. Moon 1F
...
MistyData:
	db "MISTY@",MOVES
		db 19,GOLDEEN,PECK,BUBBLEBEAM,HORN_ATTACK,NO_MOVE
		db 20,PSYDUCK,CONFUSION,BUBBLEBEAM,DISABLE,DIG
