...
; Route 3
	db "NAT@",MOVES
		db 11,METAPOD,TACKLE,STRING_SHOT,HARDEN,NO_MOVE
		db 11,KAKUNA,POISON_STING,STRING_SHOT,HARDEN,NO_MOVE
	...
	db -1
	db "BIGGY@",MOVES
		db 13,ODDISH,ABSORB,ACID,NO_MOVE,NO_MOVE
		db 15,BEEDRILL,POISON_STING,FURY_ATTACK,FOCUS_ENERGY,NO_MOVE
		db 15,BUTTERFREE,CONFUSION,TACKLE,POISONPOWDER,NO_MOVE
	db -1
; Mt. Moon 1F
...
LassData:
; Route 3
	db "MIMI@",LEVELS,13,PIDGEY,14,NIDORAN_M,-1
	db "SUSU@",LEVELS,14,NIDORAN_F,13,SPEAROW,-1
	db "GIGI@",LEVELS,14,JIGGLYPUFF,15,VULPIX,-1
; Route 4
	db "CRISSY@",31,PARAS,PARAS,PARASECT,-1
; Mt. Moon 1F
	db "MIRIAM@",14,ODDISH,BELLSPROUT,-1
	db "IRIS@",MOVES
...
; Route 25
	db "KELSEY@",LEVELS,16,ODDISH,17,NIDORINA,-1
	db "HALEY@",LEVELS,16,BELLSPROUT,18,MEOWTH,-1
; SS Anne 1F Rooms
...
; Route 24
	db "SHANE@",LEVELS,17,SANDSHREW,19,EKANS,-1
; Route 24
	db "ETHAN@",LEVELS,18,DIGLET,21,MANKEY,-1
; Route 6
	db "RICKY@",20,SQUIRTLE,-1
	db "JEFF@",16,SPEAROW,RATICATE,-1
; Route 25
	db "FLINT@",LEVELS,20,DROWZEE,19,KADABRA,-1
; Route 9
...
SuperNerdData:
; Mt. Moon 1F
	db "JOVAN@",15,MAGNEMITE,MAGNEMITE,-1
; Mt. Moon B2F
	db "MIGUEL@",15,GRIMER,MAGNEMITE,KOFFING,-1
; Route 8
...
HikerData:
; Mt. Moon 1F
	db "MARCOS@",14,GEODUDE,GEODUDE,ONIX,-1
; Route 25
	db "FRANKLIN@",18,MACHOP,GEODUDE,-1
	db "NOB@",18,VULPIX,RHYHORN,-1
	db "WAYNE@",19,ONIX,-1
; Route 9
...
RocketData:
; Mt. Moon B2F
	db "GRUNT@",15,RATTATA,ZUBAT,-1
	db "GRUNT@",15,SANDSHREW,RATTATA,ZUBAT,-1
	db "GRUNT@",15,ZUBAT,EKANS,RATTATA,-1
	db "GRUNT@",LEVELS,16,EKANS,RATICATE,-1
; Cerulean City
	db "GRUNT@",17,MACHOP,DROWZEE,-1
; Route 24
	db "GRUNT@",21,GOLBAT,-1
; Game Corner
...
MistyData:
	db "MISTY@",MOVES
		db 21,PSYDUCK,CONFUSION,BUBBLEBEAM,DISABLE,DIG
		db 22,TENTACOOL,WRAP,BUBBLEBEAM,SUPERSONIC,POISON_STING
		db 23,POLIWHIRL,BUBBLEBEAM,HYPNOSIS,BODY_SLAM,SEISMIC_TOSS
		db 25,STARMIE,CONFUSE_RAY,PSYBEAM,RECOVER,BUBBLEBEAM
	db -1
