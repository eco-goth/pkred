...
; Cerulean City
	db "<RIVAL>@",MOVES
		db 19,SPEAROW,RAZOR_WIND,FURY_ATTACK,NO_MOVE,NO_MOVE
		db 17,KADABRA,CONFUSION,THUNDER_WAVE,NO_MOVE,NO_MOVE
		db 17,NIDORINO,DOUBLE_KICK,HORN_ATTACK,POISON_STING,NO_MOVE
		db 19,WARTORTLE,WATER_GUN,SEISMIC_TOSS,MEGA_PUNCH,BARRAGE
	db -1
	db "<RIVAL>@",MOVES
		db 19,SPEAROW,RAZOR_WIND,FURY_ATTACK,NO_MOVE,NO_MOVE
		db 17,KADABRA,CONFUSION,THUNDER_WAVE,SEISMIC_TOSS,NO_MOVE
		db 17,NIDORINO,DOUBLE_KICK,HORN_ATTACK,POISON_STING,NO_MOVE
		db 19,IVYSAUR,VINE_WHIP,LEECH_SEED,ACID,POISONPOWDER
	db -1
	db "<RIVAL>@",MOVES
		db 19,SPEAROW,RAZOR_WIND,FURY_ATTACK,NO_MOVE,NO_MOVE
		db 17,KADABRA,CONFUSION,THUNDER_WAVE,NO_MOVE,NO_MOVE
		db 17,NIDORINO,DOUBLE_KICK,HORN_ATTACK,POISON_STING,NO_MOVE
		db 19,CHARMELEON,EMBER,MEGA_PUNCH,FURY_SWIPES,SEISMIC_TOSS
	db -1
