...
; Route 22
	db "<RIVAL>@",LEVELS,8,NIDORAN_M,9,SQUIRTLE,-1
	db "<RIVAL>@",LEVELS,8,NIDORAN_M,9,BULBASAUR,-1
	db "<RIVAL>@",LEVELS,8,NIDORAN_M,9,CHARMANDER,-1
; Cerulean City
...
BrockData:
	db "BROCK@",MOVES
		db 13,GEODUDE,MEGA_PUNCH,ROCK_THROW,NO_MOVE,NO_MOVE
		db 15,ONIX,ROCK_THROW,SCREECH,BIND,NO_MOVE
	db -1

MistyData:
	db "MISTY@",MOVES
		db 18,PSYDUCK,CONFUSION,BUBBLEBEAM,DISABLE,DIG
		db 19,TENTACOOL,WRAP,BUBBLEBEAM,SUPERSONIC,POISON_STING
		db 20,POLIWHIRL,BUBBLEBEAM,HYPNOSIS,BODY_SLAM,SEISMIC_TOSS
		db 22,STARMIE,CONFUSE_RAY,CONFUSION,RECOVER,BUBBLEBEAM
	db -1

LtSurgeData:
	db "LT.SURGE@",MOVES
		db 25,VOLTORB,THUNDERBOLT,SONICBOOM,EXPLOSION,NO_MOVE
		db 25,VOLTORB,THUNDERBOLT,SONICBOOM,EXPLOSION,NO_MOVE
		db 25,VOLTORB,THUNDERBOLT,SONICBOOM,EXPLOSION,NO_MOVE
...
ErikaData:
	db "ERIKA@",MOVES
		db 29,VICTREEBEL,SLEEP_POWDER,SWORDS_DANCE,ACID,RAZOR_LEAF
		db 29,EXEGGUTOR,SLEEP_POWDER,LEECH_SEED,PSYBEAM,MEGA_DRAIN
		db 30,TANGELA,LEECH_SEED,BIND,MEGA_DRAIN,SLEEP_POWDER
		db 32,VILEPLUME,SLEEP_POWDER,PETAL_DANCE,LEECH_SEED,TAKE_DOWN
	db -1
...
KogaData:
	db "KOGA@",MOVES
		...
		db 38,VENOMOTH,SLEEP_POWDER,MEGA_DRAIN,PIN_MISSILE,PSYCHIC
	db -1
