...
; Route 3
	...
	db "WARREN@",LEVELS,12,MANKEY,12,PIDGEOTTO,-1
; Mt. Moon 1F
	db "JOSH@",LEVELS,13,PIDGEY,14,VULPIX,-1
; Route 24
	db "TIMMY@",17,POLIWAG,SPEAROW,-1
; Route 25
	db "CALVIN@",17,BELLSPROUT,FARFETCHD,-1
	db "DAN@",LEVELS,17,PSYDUCK,19,SLOWPOKE,-1
	db "CHAD@",17,EKANS,ODDISH,-1
; SS Anne 1F Rooms
...
; Viridian Forest
	...
	db -1
	db "BUGSY@",LEVELS,8,ODDISH,11,PINSIR,-1
; Route 3
	db "NAT@",MOVES
	...
	db "PIPS@",MOVES
		db 9,METAPOD,TACKLE,STRING_SHOT,HARDEN,NO_MOVE
		db 9,KAKUNA,POISON_STING,STRING_SHOT,HARDEN,NO_MOVE
		db 13,PARAS,SCRATCH,STUN_SPORE,LEECH_LIFE,ABSORB
	db -1
	db "BIGGY@",LEVELS,9,ODDISH,12,BEEDRILL,12,BUTTERFREE,-1
; Mt. Moon 1F
	db "KENT@",13,BEEDRILL,BEEDRILL,-1
	db "ROBBY@",14,ZUBAT,PARAS,BUTTERFREE,-1
; Route 24
	db "CALE@",LEVELS,17,VENONAT,16,BEEDRILL,-1
; Route 6
...
; Route 3
	...
	db "SUSU@",LEVELS,12,NIDORAN_F,13,SPEAROW,-1
	db "GIGI@",LEVELS,13,JIGGLYPUFF,14,VULPIX,-1
; Route 4
	db "CRISSY@",31,PARAS,PARAS,PARASECT,-1
; Mt. Moon 1F
	db "MIRIAM@",15,ODDISH,BELLSPROUT,-1
	db "IRIS@",MOVES
		db 17,CLEFAIRY,METRONOME,SING,DOUBLESLAP,WATER_GUN
	db -1
; Route 24
	db "ALI@",17,JIGGLYPUFF,NIDORINA,-1
	db "RELI@",17,CLEFAIRY,NIDORINA,-1
; Route 25
	db "KELSEY@",LEVELS,17,ODDISH,17,NIDORINA,-1
	db "HALEY@",LEVELS,16,BELLSPROUT,17,MEOWTH,-1
; SS Anne 1F Rooms
...
; Route 25
	db "FLINT@",LEVELS,17,DROWZEE,18,KADABRA,-1
; Route 9
...
; Mt. Moon B2F
	db "MIGUEL@",LEVELS,16,GRIMER,15,MAGNEMITE,16,KOFFING,-1
; Route 8
...
HikerData:
; Mt. Moon 1F
	db "MARCOS@",14,GEODUDE,GEODUDE,RHYHORN,-1
; Route 25
	db "FRANKLIN@",17,MACHOP,GEODUDE,-1
	db "NOB@",17,VULPIX,RHYHORN,-1
	db "WAYNE@",17,ONIX,-1
; Route 9
...
; Cerulean City
	db "<RIVAL>@",MOVES
		db 19,SPEAROW,RAZOR_WIND,FURY_ATTACK,PECK,NO_MOVE
		db 17,KADABRA,CONFUSION,THUNDER_WAVE,SEISMIC_TOSS,NO_MOVE
		db 17,NIDORINO,DOUBLE_KICK,HORN_ATTACK,POISON_STING,NO_MOVE
		db 19,WARTORTLE,WATER_GUN,MEGA_PUNCH,BARRAGE,NO_MOVE
	db -1
	db "<RIVAL>@",MOVES
		db 19,SPEAROW,RAZOR_WIND,FURY_ATTACK,PECK,NO_MOVE
		db 17,KADABRA,CONFUSION,THUNDER_WAVE,SEISMIC_TOSS,NO_MOVE
		db 17,NIDORINO,DOUBLE_KICK,HORN_ATTACK,POISON_STING,NO_MOVE
		db 19,IVYSAUR,VINE_WHIP,LEECH_SEED,ACID,NO_MOVE
	db -1
	db "<RIVAL>@",MOVES
		db 19,SPEAROW,RAZOR_WIND,FURY_ATTACK,PECK,NO_MOVE
		db 18,KADABRA,CONFUSION,THUNDER_WAVE,SEISMIC_TOSS,NO_MOVE
		db 18,NIDORINO,DOUBLE_KICK,HORN_ATTACK,POISON_STING,NO_MOVE
		db 20,CHARMELEON,EMBER,MEGA_PUNCH,FURY_SWIPES,NO_MOVE
	db -1
...
; Mt. Moon B2F
	...
	db "GRUNT@",14,ZUBAT,EKANS,RATTATA,-1
	db "GRUNT@",MOVES
		db 15,RATICATE,HYPER_FANG,QUICK_ATTACK,WATER_GUN,FOCUS_ENERGY
	db -1
; Cerulean City
...
MistyData:
	db "MISTY@",MOVES
		db 22,TENTACOOL,ACID,BUBBLEBEAM,SUPERSONIC,WRAP
		db 22,WIGGLYTUFF,SING,BUBBLEBEAM,BODY_SLAM,REST
		db 23,POLIWHIRL,BUBBLEBEAM,HYPNOSIS,BODY_SLAM,SEISMIC_TOSS
		db 24,STARMIE,REFLECT,CONFUSION,RECOVER,BUBBLEBEAM
	db -1

LtSurgeData:
	db "LT.SURGE@",MOVES
		db 26,VOLTORB,THUNDERBOLT,SONICBOOM,EXPLOSION,THUNDER_WAVE
		db 26,VOLTORB,THUNDERBOLT,SONICBOOM,EXPLOSION,THUNDER_WAVE
		db 28,ELECTABUZZ,ROLLING_KICK,HEADBUTT,THUNDERBOLT,THUNDER_WAVE
		db 29,RAICHU,MEGA_KICK,BODY_SLAM,THUNDERBOLT,MEGA_PUNCH
	db -1
