...
MistyData:
	db "MISTY@",MOVES
		...
		db 20,TENTACOOL,WRAP,BUBBLEBEAM,SUPERSONIC,POISON_STING
		db 21,POLIWHIRL,BUBBLEBEAM,HYPNOSIS,BODY_SLAM,SEISMIC_TOSS
		db 23,STARMIE,CONFUSE_RAY,PSYBEAM,RECOVER,BUBBLEBEAM
	db -1
