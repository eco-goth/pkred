...
KogaData:
	db "KOGA@",MOVES
		db 38,WEEZING,THUNDERBOLT,SLUDGE,EXPLOSION,TOXIC
		db 38,MUK,FLAMETHROWER,TOXIC,MINIMIZE,SLUDGE
		db 39,PARASECT,SPORE,LEECH_SEED,MEGA_DRAIN,CUT
		db 40,SCYTHER,SWORDS_DANCE,SLASH,CUT,WING_ATTACK
		db 42,GOLBAT,TOXIC,BITE,CONFUSE_RAY,DOUBLE_TEAM
		db 43,VENOMOTH,SLEEP_POWDER,SLUDGE,PIN_MISSILE,PSYCHIC
	db -1
...
SabrinaData:
	db "SABRINA@",MOVES
		...
		db 43,ALAKAZAM,THUNDER_WAVE,RECOVER,PSYCHIC_M,REFLECT
	db -1
